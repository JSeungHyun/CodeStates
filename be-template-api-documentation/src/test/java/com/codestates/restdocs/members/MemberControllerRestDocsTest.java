package com.codestates.restdocs.members;
...
public class MemberControllerRestDocsTest {
    ...
    public void postMemberTest() throws Exception{
        // given
        MemberDto.Post post = new MemberDto.Post("hgd@gmail.com", "홍길동", "010-1234-1234");
        String content = gson.toJson(post);

        given(mapper.memberPostToMember(Mockito.any(MemberDto.Post.class)))
                .willReturn(new Member()); // willReturn이 최소 null은 아니어야 함
        ...
        actions
                ...
                .andExpect(header().string("Location", Matchers.is(Matchers.startsWith("/v11/members"))))
                .andDo(MockMvcRestDocumentation.document("post-member", // ===== API 문서화 관련 코드 시작)
